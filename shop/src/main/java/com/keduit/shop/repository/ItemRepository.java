...
import com.keduit.shop.dto.CategoryDTO;
...
public interface ItemRepository extends JpaRepository<Item, Long>,
  ...
  @Query(value = "select a.item_id, a.item_nm, a.brand_nm, a.item_text, a.level1, a.level2, a.price, a.item_sell_status, b.img_url" +
          " from item a ,item_img b" +
          " where a.item_id = b.item_id" +
          " and a.level2 = :level2 " +
          " group by a.item_id, a.item_nm, a.brand_nm, a.item_text, a.level1, a.level2, a.price, a.item_sell_status, b.img_url", nativeQuery = true)
  List<Item> itemCategoryList(String level2);
}